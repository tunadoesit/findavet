export const vets = [
  {slug:'paws-and-care-kypseli',name:'Paws & Care',area:'Kypseli',rating:4.9,reviews:128,price:'€25–35',metro:'Victoria · 8 min',parking:'Street parking',languages:['Greek','English'],tags:['Home visits','Cats & dogs'],emoji:'🐕',tone:'peach',open:true},
  ...
  {slug:'north-paws',name:'North Paws',area:'Chalandri',rating:4.9,reviews:172,price:'From €35',metro:'Chalandri · 7 min',parking:'Free parking',languages:['Greek','English','German'],tags:['Home visits','Imaging'],emoji:'🐾',tone:'blue',open:true},
  {slug:'seaside-vet',name:'Seaside Vet',area:'Palaio Faliro',rating:4.8,reviews:143,price:'€30–45',metro:'Trokadero tram · 5 min',parking:'Street parking',languages:['Greek','English'],tags:['Emergency','Home visits'],emoji:'🐶',tone:'sand',open:true},
